...
Desc:     Utilities for converting between RGB, HSL, HEX.
#######################################################################
"""
...
def rgb_to_hsl(rgb_array):
    """
    Convert rgb array [r, g, b] to hsl array [h, s, l].
...
def hsl_to_rgb(hsl_array):
    """
    Convert hsl array [h, s, l] to rgb array [r, g, b].
    HSL where h is in the set [0, 359] and s, l are in the set [0.0, 100.0].
